<?php get_header(); ?>
	...
	<?php if (have_posts()): while (have_posts()) : the_post(); ?>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<p><?php _e('Categorised in: ', $textdomain); the_category(', '); // Separated by commas ?></p>

			<p><?php _e('This post was written by ', $textdomain); the_author(); ?></p>
	...
	<?php else: ?>
		...
		<article>
			...
			<h1><?php _e('Sorry, nothing to display.', $textdomain); ?></h1>
